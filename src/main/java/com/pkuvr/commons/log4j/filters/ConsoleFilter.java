 ...
 */
package com.pkuvr.commons.log4j.filters;
...
public final class ConsoleFilter extends Filter {
    ...
    public final int decide(LoggingEvent loggingEvent) {
        ...
        if ((message + "").startsWith("[MESSAGE]") || (message + "").startsWith("[ADMIN COMMAND]") || (message + "").startsWith("[AUDIT]")
                || (message + "").startsWith("[ITEM]") || (message + "").startsWith("[UNKNOWN PACKET]")) {
            return DENY;
        }
