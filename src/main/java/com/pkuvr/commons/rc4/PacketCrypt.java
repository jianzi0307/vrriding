...
public class PacketCrypt {
    private static final Logger logger = Logger.getLogger(PacketCrypt.class);
    // / <summary>
    ...
    // / </summary>
    private ARC4 encryptServerData;
    // / <summary>
    // / Decrypts data sent from the client
    // / </summary>
    private ARC4 decryptClientData;

    public PacketCrypt(String sessionKey) {
...
//			logger.info( "decryptHash=" + bytes2Hex( decryptHash ) );
    ...
    public void decrypt(byte[] data) {
        decryptClientData.Process(data, 0, data.length);
    }

    public void encrypt(byte[] data) {
        encryptServerData.Process(data, 0, data.length);
    }
}
